...
# Ensure git, openssh-client, and ca-certificates are available for build and runtime scripts
...
# Copy all source files first so pnpm sees the entire workspace structure
COPY . .

# Force Git to use HTTPS instead of SSH for public repositories (fixes node-gyp fetch)
RUN git config --global url."https://github.com/".insteadOf "git@github.com:"

# Install with --no-frozen-lockfile to bypass version mismatches between package.json and lockfile
